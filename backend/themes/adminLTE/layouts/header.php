...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">'.Html::img('@web/uploads/img/logo_scrudu.png', ['class'=>'logo-image', 'alt'=>'user Image']).'</span><span class="logo-lg">'.Html::img('@web/uploads/img/logo_scrudu.png', ['class'=>'logo-login', 'alt'=>'user Image']).'</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
